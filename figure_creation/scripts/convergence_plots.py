...
def plot_convergence_data(
    ...
    def add_traces_and_vline(fig, fid, row=None, col=None, showlegend=True):
        ...
        mean_switch = (
            df_res.loc[df_res["fid"] == fid, "selector_switch_budget"]
            .dropna()
            .mean()
        )
    ...
    if not combined:
        ...
        fig.update_layout(
            ...
            legend=dict(
                ...
                bordercolor="black",
                borderwidth=1,
                font=dict(size=20, family="Latin Modern Roman", color="black"),
            ),
        )
