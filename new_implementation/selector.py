...
def create_selection_model_data(data_path: str, switching_budgets: list, normalise: bool = True, a2_algos: list = ["Elitist", "PSO", "DE", "BFGS", "MLSL", "Non-elitist"], store_data: bool = False, output_path: str = None):
    """
...
def get_crossvalidated_predictions(selection_model_training_data: dict, safe: bool = False, data_output_path: str = "./data", 
...
def find_optimal_budgets_per_run(crossvalidated_predictions: pd.DataFrame, tie_breaking_strategy: str = "highest_budget", safe: bool = False, data_output_path: str = "./data") -> dict:
    """
...
def create_switch_model_data(selection_model_training_data: dict[int, pd.DataFrame], store: bool = True, data_output_path: str = "./data", 
    ...
    crossvalidated_predictions = get_crossvalidated_predictions(selection_model_training_data, safe=safe_crossvalidated_predictions, data_output_path=data_output_path)

    optimal_budgets_per_run = find_optimal_budgets_per_run(crossvalidated_predictions, safe=safe_optimal_budgets, data_output_path=data_output_path)
...
class DynamicSelector:
    ...
    def train_models(self, data_path: str, store_trained_models: bool = True, model_save_path: str = "./models"):
        # Implementation for fitting the selection models for each switching budget
        selection_model_training_data = create_selection_model_data(data_path=data_path, switching_budgets=self.switching_budgets, store_data=True, output_path=data_path)
        switching_model_training_data = create_switch_model_data(selection_model_training_data, safe_crossvalidated_predictions=True, safe_optimal_budgets=True, data_output_path=data_path)
        # FINAL TRAINING HERE

    def evaluate(self, features: pd.DataFrame) -> np.ndarray:
        # Implementation for predicting the best A2 algorithm given the ELA features and the switching budget
        pass

if __name__ == "__main__":    # Example usage
    selection_model_data = create_selection_model_data(data_path="./data", switching_budgets=[50*i for i in range(2, 21)], normalise=True, store_data=True, output_path="./data/selection_model_data")

    switching_model_data = create_switch_model_data(selection_model_data, safe_crossvalidated_predictions=True, safe_optimal_budgets=True, data_output_path="./data")