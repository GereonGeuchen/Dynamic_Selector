...
ELA_DIR_SWITCH = "../data/switch_data/auc/A1_data_algo_features_switch_auc_highest_with_lookahead_predictions_new_norm"
...
if __name__ == "__main__":
    ...
    SMAC_OUTPUT_DIR = f"smac_lookaheads/smac_output_switch_lookahead_lowest_{NUM_LOOKAHEAD_EPMS}"
    OUTPUT_PATH = f"../data/models/trained_models/auc/switching_models_highest_new_normalisation/switching_models_lookahead_untuned_{NUM_LOOKAHEAD_EPMS}"
