...
for BUDGET in "${BUDGETS[@]}"; do
  sbatch <<EOF
#!/bin/bash
#SBATCH --job-name=${BUDGET}_training_untuned_auc
#SBATCH --output=${WORKDIR}/logs/${BUDGET}_training_untuned_auc.out
#SBATCH --error=${WORKDIR}/logs/${BUDGET}_training_untuned_auc.err
