...
#!/bin/bash
#SBATCH -A p0026688
#SBATCH --job-name=${BUDGET}_training_lookahead_t${I}_untuned_auc_new_norm
#SBATCH --output=${WORKDIR}/logs/${BUDGET}_training_lookahead_t${I}_untuned_auc_new_norm.out
#SBATCH --error=${WORKDIR}/logs/${BUDGET}_training_lookahead_t${I}_untuned_auc_new_norm.err
